...
from service.main_util import get_com_ports
from сkiu import ServerCKIU
from dialogues import err_port_close
from bpk_06 import BPK_06
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.bpk_06 = BPK_06(self.ui, self.ports, self.server)

    def _setup_param_default(self):
        # ===================================
        # self.ui.sn_lineEdit.setText("35690")
        self.ui.sn_lineEdit.setText("1256")
        # ===================================
        ...
        # BPK ======================================
        self.ui.bpk_06_radioButton.setChecked(True)
    ...
    def _start_ckiu_02(self):
        ...
        if self.server is None:
            ...
            if self.ui.version_old_ckiu_radioButton.isChecked():
                version = 1
            elif self.ui.version_acp_radioButton.isChecked():
                version = 2
            elif self.ui.version_ibp_radioButton.isChecked():
                version = 3
